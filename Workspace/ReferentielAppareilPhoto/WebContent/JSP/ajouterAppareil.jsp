	...
	<div class="container">
		<html:form method="POST" enctype="multipart/form-data">
				...
				<tr>
					...
					<td><div class="form-group">
							<html:select property="idModele">
								<html:optionsCollection name="AppareilForm" property="modeles"
									label="nom" value="id" />
							</html:select>
						</div>
					</td>
					...
					<td>
						<div class="form-group">
							<html:select property="idType">
								<html:optionsCollection name="AppareilForm" property="types"
									label="nom" value="id" />
							</html:select>
						</div>
					</td>
			...
			<table>
				<tr>
					<td>
						<input type="submit" name="actionMethod" value="Enregistrer" class="btn"/>
					</td>
					<td>
						<input type="submit" name="actionMethod" value="Retour" class="btn"/>
					</td>
				</tr>
			</table>
		</html:form>
